...
.\config.cmd --deploymentgroup --deploymentgroupname "NPS-UT" --agent $env:COMPUTERNAME --runasservice --work '_work' --url 'https://dev.azure.com/npsnatgen/' --projectname 'NPS'; 
